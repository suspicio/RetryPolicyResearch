...
public class RetryProfileRequesterService {
    ...
    public void addStats(Integer initialTime, Duration duration, Integer statusCode, Boolean isRetry) {
        ...
        testingStats.addSuccessRateOfRequestsBySeconds(initialTime, statusCode < 300);
        testingStats.addAverageTimeForRequestsPerSecondByTime(initialTime, Long.valueOf(duration.toMillis()).doubleValue());
        if (isRetry) {
